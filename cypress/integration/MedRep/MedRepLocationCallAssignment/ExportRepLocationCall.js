/*
 * @Author: sachin 
 * @Date: 2021-11-15 14:04:13 
 * @Last Modified by: sachin
 * @Last Modified time: 2021-11-15 14:15:46
 */


/// <reference types="cypress" />
describe('Testing Export MedRep Location calls Assignment ', function () {
    beforeEach(function () {
        // "this" points at the test context object
        cy.fixture('datafile').as('data')
        cy.fixture('MedRep/LocationCallsAssignment/ExportLocationCalls').as('Doctordata')
        cy.on('uncaught:exception', (err, runnable) => {

            return false
        })
    })
    it('Export MedRep Location calls', function () {
        ...
        cy.task('downloads', 'cypress/downloads').then(before => {
            ...
            cy.window().document().then(function (doc) {
                ...
                cy.task('log', 'Clicked on Med Rep Location-Calls Export Button')
            })
