 ...
 * @Last Modified time: 2021-11-12 14:17:58
 */

/// <reference types="cypress" />
describe('Testing Export MedRep Doctor calls Assignment ', function () {
    beforeEach(function () {
        // "this" points at the test context object
        cy.fixture('datafile').as('data')
        cy.fixture('MedRep/DoctorCallsAssignment/ExportDoctorCalls').as('Doctordata')
        cy.on('uncaught:exception', (err, runnable) => {

            return false
        })
    })
    it('Export MedRep Doctors calls', function () {
